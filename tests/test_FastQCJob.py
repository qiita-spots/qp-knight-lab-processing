...
class TestFastQCJob(unittest.TestCase):
    ...
    def test_generate_job_scripts(self):
        ...
        exp = [
            ...
            "cd tests/data/output_dir2/FastQCJob",
            "",
            "module load my_module.1.1",
            "",
    ...
    def test_completed_file_generation_some_failures(self):
        ...
        log_fp = join(
            self.output_path, "FastQCJob", "logs", "failed_indexes_2345.barnacle.json"
        )
        ...
        with open(log_fp, "r") as f:
            obs = load(f)
            exp = {"job_id": "2345.barnacle", "failed_indexes": [3, 4]}
