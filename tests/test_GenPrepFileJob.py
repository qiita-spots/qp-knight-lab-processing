...
class TestGenPrepFileJob(unittest.TestCase):
    def setUp(self):
        ...
        self.working_directory_root = join(self.package_root, self.qiita_job_id)
        try:
        ...
        makedirs(join(self.qc_job_path, self.project_list[0], "filtered_sequences"))
        makedirs(
            join(self.qc_job_path, self.project_list[0], "fastp_reports_dir", "json")
        )
    ...
    def test_creation(self):
        sample_sheet_path = join(
            self.package_root, "tests", "data", "good-sample-sheet.csv"
        )
        ...
        lines = [re.sub(r"^.*?sequence_processing_pipeline\/", "", x) for x in lines]
        obs = [x for x in lines if x]
        obs.sort()

        exp = [
            "b197f317-1c06-4619-9af3-65721149c1e8/210518_A00953_0305_TEST",
            "b197f317-1c06-4619-9af3-65721149c1e8/210518_A00953_0305_TEST/ConvertJob",
            "b197f317-1c06-4619-9af3-65721149c1e8/210518_A00953_0305_TEST/"
            "ConvertJob/Reports",
            "b197f317-1c06-4619-9af3-65721149c1e8/210518_A00953_0305_TEST/QCJob",
            "b197f317-1c06-4619-9af3-65721149c1e8/210518_A00953_0305_TEST/"
            "QCJob/Project1",
            "b197f317-1c06-4619-9af3-65721149c1e8/210518_A00953_0305_TEST/"
...
class TestReplication(unittest.TestCase):
    ...
    def test_sample_sheet_replicate_file_creation(self):
        ...
        sample_sheet_path = join(
            self.package_root, "tests", "data", "good_sheet_w_replicates.csv"
        )
    ...
    def test_pre_prep_replicate_file_creation(self):
        ...
        # and the correct number of output files are created.
        sample_sheet_path = join(
            self.package_root, "tests", "data", "pre_prep_w_replicates.csv"
        )
