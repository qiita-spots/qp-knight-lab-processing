...
class TestMultiQCJob(unittest.TestCase):
    def setUp(self):
        ...
        self.raw_fastq_files_path = (
            "tests/data/211021_A00000_0000_SAMPLE/Data/Fastq/project1"
        )
        ...
        file_names = []
        makedirs(join(base_path, "StudyB_11661", "trimmed_sequences"), exist_ok=True)
        makedirs(join(base_path, "StudyC_6123", "filtered_sequences"), exist_ok=True)
    ...
    def test_generate_job_scripts(self):
        job = MultiQCJob(
            ...
            "8g",
            30,
            self.fastqc_root_path,
            1000,
            "tests/data/multiqc-bclconvert-config.yaml",
            False,
        )
        ...
        exp = [
            ...
            "#SBATCH -n 16",
            "#SBATCH --time 23",
            "# fastqc/multiqc use the same mem "
        ...
        exp = [
            "multiqc -c tests/data/multiqc-bclconvert-con"
