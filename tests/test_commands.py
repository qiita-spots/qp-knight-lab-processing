...
from sequence_processing_pipeline.Commands import demux, split_similar_size_bins
...
class CommandTests(unittest.TestCase):
    ...
    def test_split_similar_size_bins(self, glob, stat):
        ...
        with TemporaryDirectory() as tmp:
            ...
            exp_1 = (
                "/foo/bar/a_R1_001.fastq.gz\t/foo/bar/a_R2_001.fastq.gz"
                "\tbar\n"
    ...
    def test_split_similar_size_bins_odd_sample_names(self, glob, stat):
        ...
        mockglob = [
            "/foo/bar/Sample1_R1_001.fastq.gz",
    ...
    def test_demux(self):
        with TemporaryDirectory() as tmp:
            ...
            obs_r1 = gzip.open(join(tmp, "Project_12345", "b_R1.fastq.gz"), "rt").read()
            obs_r2 = gzip.open(join(tmp, "Project_12345", "b_R2.fastq.gz"), "rt").read()
            exp = "\n".join(exp_data_r1) + "\n"
    ...
    def test_demux_w_metadata(self):
        with TemporaryDirectory() as tmp:
            ...
            infile_data = "\n".join(
                [
                    "@1::MUX::foo/1 BX:Z:TATGACAGATGCGGCCCT",
                    "ATGC",
                    "+",
                    "!!!!",
