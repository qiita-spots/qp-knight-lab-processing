...
def process_amplicon(mapping_file_path, qclient, run_identifier, out_dir,
    ...
    # perform sample-id validation against Qiita here
        ...
        SAMPLE ID VALIDATION CODE HERE
        ...
        # unlike metagenomics, we won't overwrite any corrections or changes
        # to the mapping file and initialize the pipeline based on that file.
        # instead we'll create a pipeline with the original file and if there
        # is errors, we'll return an error.
    ...
    '''
    Prep Information File generation disabled.
